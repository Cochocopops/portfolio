...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    categories: ['Product Design', 'Biomaterials'],
  ...
  },
  {
    ...
    categories: ['Electronics', 'Code & Software', 'Mechanical Engineering'],
  ...
  },
  {
    ...
    categories: ['Biomaterials', 'Product Design'],
  ...
  },
  {
    ...
    categories: ['Biomaterials', 'Product Design', 'Tutorials'],
